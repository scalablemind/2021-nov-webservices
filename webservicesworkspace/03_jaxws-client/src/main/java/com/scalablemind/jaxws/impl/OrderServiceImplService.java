 ...
 * 
 */
@WebServiceClient(name = "OrderServiceImplService", targetNamespace = "http://impl.jaxws.scalablemind.com/", wsdlLocation = "http://localhost:8080/jaxws/updateorder?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ORDERSERVICEIMPLSERVICE_QNAME = new QName("http://impl.jaxws.scalablemind.com/", "OrderServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/jaxws/updateorder?wsdl");
    ...
    public OrderServiceImpl getOrderServiceImplPort() {
        return super.getPort(new QName("http://impl.jaxws.scalablemind.com/", "OrderServiceImplPort"), OrderServiceImpl.class);
    }
    ...
    public OrderServiceImpl getOrderServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.jaxws.scalablemind.com/", "OrderServiceImplPort"), OrderServiceImpl.class, features);
    }
